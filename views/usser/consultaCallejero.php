			...
			<ul class="nav">
                ...
                <li><a href="">CALLEJERO</a>
                    <ul>
						...
						<li><form action="./consultaCallejero"><button type="submit" value="Consultar"></button></form><!--form action="./consultaCallejero"><button><a href="../usser/consultaCallejero.php">Consultar</a></button></form--></li>
